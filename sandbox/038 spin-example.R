...
#- Introduction
#' This is a special R script which can be used to generate a report. 
#' You can write normal text in roxygen comments.
#' 
...
#' Done. Call spin('spin-example.R') to make silk from sow's ear now 
#' and knit a lovely purse.
